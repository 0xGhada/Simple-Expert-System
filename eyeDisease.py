...
class eyeDisease(KnowledgeEngine):
    ...
    #night blindness
    @Rule(AND(Fact(itching='0'), Fact(blurring='1'), Fact(redness='0'), Fact(night='1'),
                  Fact(mucus='0'), Fact(tear='0'), Fact(yellowing='0'), Fact(headache='0'), Fact(cough='0'),
                  Fact(pain='0'), Fact(overstrain='1'), Fact(sensitivity='1'), Fact(rainbow='1'), Fact(double='0'),
                  Fact(sightedness='1'), Fact(sight='1'), Fact(nausea='0'), Fact(dilated='0'), Fact(eyelid='0'),
